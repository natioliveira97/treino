...
def image_name_to_time_int(image_name):
    ...
    # print(image_name)
    if "_" in image_name[-6:]:
        time_int = int(image_name[-5:])
    else:
...
def calculate_num_tiles(resize_dimensions, crop_height, tile_dimensions, tile_overlap):
    ...
    print(num_tiles_height, num_tiles_width)
...
class DataAugmentations():
    ...
    def process_bboxes(self, gt_bboxes):
        ...
        gt_bboxes=np.array(gt_bboxes).reshape((int(len(gt_bboxes)/4),4))
...
def calculate_negative_accuracy(negative_preds_dict):
    ...
    return 1 - sum(all_preds) / (len(all_preds)+0.00000000000000000000000000001)
...
def calculate_negative_accuracy_by_fire(negative_preds_dict):
    ...
    return sum(fire_preds) / (len(fire_preds)+0.000000000000000000000000000001)
...
def calculate_positive_accuracy(positive_preds_dict):
    ...
    return sum(all_preds) / (len(all_preds)+0.000000000000000000000001)
