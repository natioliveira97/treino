...
# Path args
parser.add_argument('--raw-data-path', type=str, default='./data/new_data/raw_images',
                    help='Path to raw images.')
parser.add_argument('--labels-path', type=str, default='./data/new_data/drive_clone_numpy_new',
                    help='Path to processed XML labels.')
parser.add_argument('--metadata-path', type=str, default='./data/metadata_new.pkl',
...
def main(# Debug args
    ...
    if not is_debug: 
        checkpoint_callback = ModelCheckpoint(monitor='val/tile_aucroc',mode='max', save_last=True)
