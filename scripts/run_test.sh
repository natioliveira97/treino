...
# python3.9 src/main.py \
#     --experiment-name "teste_clima_ao_vivo" \
#     --is-test-only \
#     --checkpoint-path "lightning_logs/train_test6/version_0/checkpoints/epoch=56-step=27075.ckpt" \
#     --model-type-list "RawToTile_ResNet" "TileToTile_Transformer" "TileToTileImage_SpatialViT" \
#     --omit-list "omit_no_xml" \
#     --error-as-eval-loss \
#     --use-image-preds \
...
#     --accumulate-grad-batches 16 \
#     --num-workers 4 \
#     --raw-data-path 'data/clima_ao_vivo/raw_images' \
#     --labels-path 'data/clima_ao_vivo/drive_clone_numpy_new' \
#     --metadata-path 'data/metadata_clima_ao_vivo.pkl' \
#     --train-split-path '/home/natalia/pytorch-lightning-smoke-detection/data/clima_ao_vivo/test_split.txt' \
#     --val-split-path '/home/natalia/pytorch-lightning-smoke-detection/data/clima_ao_vivo/test_split.txt' \
#     --test-split-path '/home/natalia/pytorch-lightning-smoke-detection/data/clima_ao_vivo/test_split.txt' \
#     --tile-embedding-size 1000 \
#     --original-height 1536 \
#     --original-width 2048 \
#     --resize-height 1080 \
...
# python3.9 src/main.py \
#     --is-test-only \
#     --experiment-name "train_test4" \
#     --checkpoint-path "lightning_logs/train_test4/version_5/checkpoints/epoch=54-step=11880.ckpt" \
#     --model-type-list "RawToTile_ResNet" "TileToTile_Transformer" "TileToTileImage_SpatialViT" \
#     --omit-list "omit_no_xml" \
#     --error-as-eval-loss \
#     --use-image-preds \
...
#     --no-early-stopping \
#     --tile-embedding-size 1000 \
#     --raw-data-path 'data/new_data_2/raw_images' \
#     --labels-path 'data/new_data_2/drive_clone_numpy_new' \
#     --metadata-path 'data/metadata_new2.pkl' \
#     --original-height 1536 \
#     --original-width 2048 \
#     --resize-height 1080 \
#     --resize-width 1920 \
...
# python3.9 src/main.py \
#     --experiment-name "train_good_videos" \
#     --is-test-only \
#     --checkpoint-path "./lightning_logs/train_good_videos/version_4/checkpoints/epoch=13-step=2702.ckpt" \
#     --model-type-list "RawToTile_ResNet" "TileToTile_Transformer" "TileToTileImage_SpatialViT" \
#     --omit-list "omit_no_xml" \
#     --error-as-eval-loss \
#     --use-image-preds \
...
#     --accumulate-grad-batches 16 \
#     --num-workers 4 \
#     --train-split-path './data/split_teste/test.txt' \
#     --val-split-path './data/split_teste/test.txt' \
#     --test-split-path './data/split_teste/test.txt' \
#     --no-early-stopping \
#     --tile-embedding-size 1000 \
#     --original-height 480 \
#     --original-width 640 \
...
#     --accumulate-grad-batches 16 \
#     --num-workers 4 \
#     --train-split-path 'lightning_logs/Final_ResNet_Transformer_SpatialViT/version_11/train_images.txt' \
