...
metadata = pickle.load(open('./data/metadata_new.pkl', 'rb'))
raw_data_path = 'data/new_data/raw_images'
save_path_mog = 'data/new_data/raw_images_mog_new/'
save_path_flow = 'data/new_data/raw_images_flow_new/'
