python3.7 treino/src/main.py \
    ...
    --num-workers 6 \
    --train-split-path '/kaggle/input/dataset-artigo/train_files.txt' \
    --val-split-path '/kaggle/dataset-artigo/val_files.txt' \
    --test-split-path '/kaggle/dataset-artigo/test_files.txt' \
    --no-early-stopping \
    --tile-embedding-size 1000 \
    --raw-data-path '/kaggle/input/dataset-artigo/raw_images' \
    --labels-path '/kaggle/input/dataset-artigo/drive_clone_numpy_new' \
